...
namespace ApiTajamar.Controllers
{
    ...
    public class UsuariosController : ControllerBase
    {
        ...
        public async Task<ActionResult<List<Usuario>>> GetUsuariosPorIdClase(int idClase)
        {
            try
            {
        ...
        public async Task<ActionResult<List<Usuario>>> GetUsuariosPorEmpresa(int idEmpresa)
        {
            try
            {
